...
class Glpi_Kernel_KernelProductionContainer extends Container
{
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('zugQmQUe6l', 0, $container->getParameter('container.build_id'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dUeX02dGt4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+kaxFcRFTX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['logger'] ?? $container->get('logger', 3)));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'glpi.default_secret' => '98230821ead9fdcfb18c1cb6544e0c6ec10f394dbfb3ac2f990d63027c274102',
