...
//             // 2- Creer le lien Ticket<->Asset (POST Item_Ticket)   
//             if (!assets || !Array.isArray(assets) || assets.length === 0) {
//                 console.warn('[Create ticket] Aucun asset à lier.');
//                 return ticketId; // on retourne quand même l'id du ticket créé
//             }
...
//             throw err; // propager pour que la page puisse réagir
//         } finally {
//             setLoading(false); // toujours remettre loading à false
//         }
//     }
...
// hooks/ticket/useCreateTicket.js
import { useState } from "react";
import { ImportTicketRepository } from "../../domain/repositories/ImportTicketRepository";
